...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Niryo miniVLA V4 Step-Replay Collector"
    )

    parser.add_argument("--robot-ip", default="169.254.200.200")
    parser.add_argument("--dataset-dir", default="dataset_push_real_v4")
...
def build_episode_arrays(
    ...
    arrays = {
        ...
        # Collector metadata
        "collector_version": np.asarray("v4_step_replay_tpes_no_padding", dtype=object),
...
def main():
    ...
    print("")
    print("=" * 80)
    print("🔥 NIRYO miniVLA COLLECTOR V4 - TPES STEP REPLAY")
    print("=" * 80)
    ...
    cv2.namedWindow("TPES_V4", cv2.WINDOW_NORMAL)
